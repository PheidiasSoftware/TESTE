...
Também é aceitável usar `http://localhost:11434`, um IPv4 de loopback válido no bloco `127.0.0.0/8` em formato decimal completo com quatro octetos, ou `http://[::1]:11434` quando o Ollama estiver respondendo no loopback local.
...
- `localhost`
- `127.0.0.1` e demais endereços IPv4 válidos em `127.0.0.0/8`, sempre em formato decimal completo com quatro octetos
- `::1`

URLs com host remoto, IP de rede local, domínio público, túnel, serviço externo, IPv4 malformado ou alias IPv4 ambíguo são normalizadas para o padrão seguro `http://127.0.0.1:11434`. Isso evita que prompts e trechos de código do projeto sejam enviados para fora do computador por configuração acidental e evita endpoints locais ambíguos que falhariam em tempo de execução.
...
OLLAMA_URL=http://127.1:11434
OLLAMA_URL=http://2130706433:11434
OLLAMA_URL=http://0x7f000001:11434
OLLAMA_URL=http://0177.0.0.1:11434
```
...
- Não use IPv4 local malformado, abreviado, inteiro, hexadecimal ou octal; prefira `127.0.0.1`.
